...
|---|---|---|---|---|
| `ghcr.io/sirosfoundation/go-trust` | [sirosfoundation/go-trust](https://github.com/sirosfoundation/go-trust) | `0.18` | `55dfcdb` | 0.18, 0.18.0, 0.17, 0.17.0, 0.16, 0.16.0, 0.15.1, 0.15, 0.15.0, 0.14.1 |
| `ghcr.io/sirosfoundation/wallet-frontend` | [sirosfoundation/wallet-frontend](https://github.com/sirosfoundation/wallet-frontend) | `0.5.0-1-sirosid.10` | `unstable-eb208fb` | 0.5.0-1-sirosid.10, 0.5.0-1-sirosid.9, 0.5.0-1-sirosid.8, 0.5.0-1-sirosid.7, 0.5.0-1-sirosid.6, 0.5.0-1-sirosid.5, 0.5.0-1-sirosid.4, 0.5.0-1-sirosid.3, 0.5.0-1-sirosid.2, 0.5.0-1-sirosid.1 |
...
| `ghcr.io/sirosfoundation/vc/registry` | [sirosfoundation/vc](https://github.com/sirosfoundation/vc) | `0.7.0-sirosid.1` | `a5ba027` | 0.7.0-sirosid.1, 0.7, 0.7.0-sirosid.0, 0.7.0, v0.6.5-sirosid.9, v0.6.5-sirosid.8, v0.6.5-sirosid.7, v0.6.5-sirosid.6, v0.6.5-sirosid.5, v0.6.5-sirosid.4 |
...
| `ghcr.io/sirosfoundation/go-wallet-backend` | [sirosfoundation/go-wallet-backend](https://github.com/sirosfoundation/go-wallet-backend) | `0.14.1` | `2caa82f` | 0.14.1, 0.14, 0.14.0, 0.13, 0.13.0, 0.12, 0.12.0, 0.11.1, 0.11, 0.11.0 |
...
| `ghcr.io/sirosfoundation/go-grc` | [sirosfoundation/go-grc](https://github.com/sirosfoundation/go-grc) | `0.13.1` | `dbb7953` | 0.13.1, 0.13, 0.13.0, 0.12, 0.12.0, 0.11.2, 0.11.1, 0.11.0-arm64, 0.11.0-amd64, 0.11 |
...
| `ghcr.io/sirosfoundation/mini-oidc` | [sirosfoundation/mini-oidc](https://github.com/sirosfoundation/mini-oidc) | `0.0.3` | `sha-56cf336` | 0.0.3, 0.0.2, 0.0, 0.0.1 |

_Last updated: 2026-08-22T14:06:45Z_
