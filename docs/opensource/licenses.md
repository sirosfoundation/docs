...
**20** repositories scanned · **2859** unique packages · **60** license types · **63** unresolved
...
License policy overrides applied: **659** · Dual-license selections: **157**

## License Summary

| License | Category | Unique Packages | Total Usages |
|---------|----------|---------------:|-------------:|
| MIT | allowed | 1261 | 2380 |
| Apache-2.0 | allowed | 540 | 777 |
| BSD-3-Clause | allowed | 84 | 169 |
| BSD-2-Clause | allowed | 70 | 139 |
| ISC | allowed | 45 | 104 |
...
|------------|------------:|----------|
| [browser-log](https://github.com/sirosfoundation/browser-log) | 319 | MIT (270), ISC (12), MPL-2.0 (12), BSD-2-Clause (9), Apache-2.0 (4), BSD-3-Clause (4), MIT-0 (2), CC0-1.0 (1), BlueOak-1.0.0 (1), Python-2.0 (1), Apache-2.0 AND BSD-2-Clause AND CC0-1.0 AND ISC AND MIT (1), 0BSD (1), BSD-2-Clause AND BSD-3-Clause (1) |
...
| [g119612](https://github.com/sirosfoundation/g119612) | 37 | MIT (15), BSD-2-Clause (7), BSD-3-Clause (5), Apache-2.0 (5), ISC (1), NOASSERTION (1), BSD-3-Clause AND LicenseRef-scancode-google-patent-license-golang (1), EUPL-1.2 (1), LGPL-3.0 (1) |
...
| [go-r2ps-service](https://github.com/sirosfoundation/go-r2ps-service) | 47 | MIT (20), Apache-2.0 (10), BSD-3-Clause (10), BSD-2-Clause (3), Apache-2.0 AND BSD-3-Clause AND MIT (1), Apache-2.0 AND MIT (1), BSD-3-Clause AND LicenseRef-scancode-google-patent-license-golang (1), LGPL-3.0 (1) |
...
| [r2ps-client](https://github.com/sirosfoundation/r2ps-client) | 163 | MIT (108), Apache-2.0 (29), Unicode-3.0 (18), ISC (2), CDLA-Permissive-2.0 (2), BSD-3-Clause (1), Apache-2.0 AND ISC (1), LGPL-3.0 (1), BSD-2-Clause (1) |
...
| [siros-sdk-kotlin](https://github.com/sirosfoundation/siros-sdk-kotlin) | 480 | Apache-2.0 (423), MIT (18), BSD-3-Clause (15), EPL-2.0 (7), BSD-2-Clause (3), LGPL-2.1 (1), LicenseRef-scancode-jdom (1), CDDL-1.0 (1), Apache-2.0 AND CC0-1.0 (1), Apache-2.0 AND BSD-2-Clause AND BSD-3-Clause AND Elastic-2.0 AND LicenseRef-scancode-public-domain AND MIT AND bzip2-1.0.6 (1), Apache-2.0 AND MIT (1), Apache-2.0 AND BSD-3-Clause (1), Apache-2.0 AND LicenseRef-scancode-public-domain AND bzip2-1.0.6 (1), EPL-1.0 (1), CDDL-1.1 (1), CC0-1.0 (1), NOASSERTION (1), MPL-1.1 (1), LGPL-3.0 (1) |
...
| [vc](https://github.com/sirosfoundation/vc) | 211 | MIT (81), Apache-2.0 (74), BSD-3-Clause (29), BSD-2-Clause (10), BSD-3-Clause AND LicenseRef-scancode-google-patent-license-golang (3), Apache-2.0 AND MIT (3), ISC (2), Apache-2.0 AND LicenseRef-scancode-dco-1.1 AND MIT (1), MIT-0 (1), Apache-2.0 AND CC-BY-SA-4.0 (1), BSD-2-Clause-Views (1), Apache-2.0 AND BSD-3-Clause (1), Apache-2.0 AND BSD-2-Clause AND BSD-3-Clause (1), Apache-2.0 AND CC-BY-3.0 AND MIT (1), Apache-2.0 AND BSD-3-Clause AND MIT (1), MPL-2.0 (1) |
| [wallet-common](https://github.com/sirosfoundation/wallet-common) | 210 | MIT (174), Apache-2.0 (18), BSD-3-Clause (7), ISC (2), 0BSD (2), BSD-2-Clause (2), LicenseRef-scancode-generic-cla AND MIT (1), BSD-3-Clause AND ISC AND MIT (1), 0BSD AND ISC AND MIT (1), MIT AND Zlib (1), BSD-2-Clause AND CC0-1.0 AND ISC AND MIT (1) |
| [wallet-companion](https://github.com/sirosfoundation/wallet-companion) | 681 | MIT (499), Apache-2.0 (47), ISC (35), BSD-2-Clause (30), MPL-2.0 (18), BSD-3-Clause (14), LGPL-3.0-or-later (10), CC0-1.0 AND MIT (5), BlueOak-1.0.0 (3), Apache-2.0 AND LGPL-3.0-or-later (3), CC0-1.0 (2), Apache-2.0 AND MIT (2), MIT-0 (2), NOASSERTION (1), Apache-2.0 AND OFL-1.1 AND Ubuntu-font-1.0 (1), ISC AND MIT (1), Python-2.0 (1), 0BSD (1), Apache-2.0 AND LGPL-3.0-or-later AND MIT (1), LicenseRef-scancode-unicode AND MIT (1), BSD-2-Clause AND BSD-2-Clause-Views (1), MIT AND Zlib (1), BSD-2-Clause AND BSD-3-Clause (1), LGPL-3.0 (1) |
| [wallet-frontend](https://github.com/sirosfoundation/wallet-frontend) | 1107 | MIT (908), Apache-2.0 (60), ISC (40), BSD-2-Clause (21), BSD-3-Clause (19), MPL-2.0 (13), BSD-2-Clause AND LGPL-2.0-only AND LGPL-2.1-only AND LGPL-3.0-only AND LGPL-3.0-or-later AND LicenseRef-scancode-other-permissive AND MIT AND MPL-2.0 (10), Apache-2.0 AND BSD-2-Clause AND LGPL-2.0-only AND LGPL-2.1-only AND LGPL-3.0-only AND LGPL-3.0-or-later AND LicenseRef-scancode-other-permissive AND MIT AND MPL-2.0 (3), CC0-1.0 AND MIT (3), ISC AND MIT (3), 0BSD (2), MIT-0 (2), CC0-1.0 (2), BlueOak-1.0.0 (2), Apache-2.0 AND BSD-2-Clause (2), LicenseRef-scancode-public-domain (1), 0BSD AND ISC AND MIT (1), Apache-2.0 AND MIT (1), CC-BY-4.0 (1), MIT AND Zlib (1), BSD-2-Clause AND BSD-3-Clause (1), Apache-2.0 AND OFL-1.1 AND Ubuntu-font-1.0 (1), NOASSERTION (1), AFL-2.1 AND AFL-3.0 AND BSD-3-Clause (1), Apache-2.0 AND BSD-2-Clause AND CC0-1.0 AND ISC AND MIT (1), LicenseRef-scancode-generic-cla AND MIT (1), Python-2.0 (1), BSD-2-Clause AND BSD-2-Clause-Views (1), BSD-3-Clause AND MIT (1), Apache-2.0 AND BSD-2-Clause AND BlueOak-1.0.0 AND CC0-1.0 AND ISC AND MIT (1), Apache-2.0 AND BSD-3-Clause AND ISC AND MIT (1), LGPL-3.0 (1) |
...
_Last updated: 2026-07-08T07:18:34Z_
