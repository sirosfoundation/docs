...
**19** repositories scanned · **2839** unique packages · **59** license types · **61** unresolved
...
License policy overrides applied: **640** · Dual-license selections: **148**

## License Summary

| License | Category | Unique Packages | Total Usages |
|---------|----------|---------------:|-------------:|
| MIT | allowed | 1262 | 2109 |
| Apache-2.0 | allowed | 545 | 779 |
| BSD-3-Clause | allowed | 84 | 156 |
| BSD-2-Clause | allowed | 67 | 128 |
| ISC | allowed | 45 | 91 |
| NOASSERTION | unclassified | 61 | 61 |
| MPL-2.0 | build-only | 20 | 44 |
...
| [g119612](https://github.com/sirosfoundation/g119612) | 38 | MIT (17), BSD-2-Clause (7), Apache-2.0 (5), BSD-3-Clause (5), BSD-3-Clause AND LicenseRef-scancode-google-patent-license-golang (1), ISC (1), EUPL-1.2 (1), LGPL-3.0 (1) |
...
| [go-r2ps-service](https://github.com/sirosfoundation/go-r2ps-service) | 47 | MIT (20), BSD-3-Clause (10), Apache-2.0 (10), BSD-2-Clause (3), Apache-2.0 AND BSD-3-Clause AND MIT (1), BSD-3-Clause AND LicenseRef-scancode-google-patent-license-golang (1), Apache-2.0 AND MIT (1), LGPL-3.0 (1) |
...
| [go-wallet-backend](https://github.com/sirosfoundation/go-wallet-backend) | 101 | MIT (43), Apache-2.0 (26), BSD-3-Clause (16), BSD-2-Clause (10), BSD-3-Clause AND LicenseRef-scancode-google-patent-license-golang (2), Apache-2.0 AND BSD-3-Clause AND MIT (1), Apache-2.0 AND MIT (1), ISC (1), LGPL-3.0 (1) |
...
| [r2ps-client](https://github.com/sirosfoundation/r2ps-client) | 163 | MIT (108), Apache-2.0 (29), Unicode-3.0 (18), ISC (2), CDLA-Permissive-2.0 (2), Apache-2.0 AND ISC (1), BSD-3-Clause (1), LGPL-3.0 (1), BSD-2-Clause (1) |
...
| [siros-sdk-kotlin](https://github.com/sirosfoundation/siros-sdk-kotlin) | 480 | Apache-2.0 (428), MIT (16), BSD-3-Clause (15), EPL-2.0 (7), BSD-2-Clause (3), LGPL-2.1 (1), Apache-2.0 AND LicenseRef-scancode-public-domain AND bzip2-1.0.6 (1), MPL-1.1 (1), EPL-1.0 (1), Apache-2.0 AND MIT (1), LicenseRef-scancode-jdom (1), Apache-2.0 AND BSD-2-Clause AND BSD-3-Clause AND Elastic-2.0 AND LicenseRef-scancode-public-domain AND MIT AND bzip2-1.0.6 (1), Apache-2.0 AND BSD-3-Clause (1), CDDL-1.0 (1), CDDL-1.1 (1), LGPL-3.0 (1) |
...
| [vc](https://github.com/sirosfoundation/vc) | 211 | MIT (81), Apache-2.0 (74), BSD-3-Clause (29), BSD-2-Clause (10), Apache-2.0 AND MIT (3), BSD-3-Clause AND LicenseRef-scancode-google-patent-license-golang (3), ISC (2), MIT-0 (1), Apache-2.0 AND CC-BY-SA-4.0 (1), MPL-2.0 (1), Apache-2.0 AND BSD-3-Clause AND MIT (1), BSD-2-Clause-Views (1), Apache-2.0 AND BSD-3-Clause (1), Apache-2.0 AND LicenseRef-scancode-dco-1.1 AND MIT (1), Apache-2.0 AND BSD-2-Clause AND BSD-3-Clause (1), Apache-2.0 AND CC-BY-3.0 AND MIT (1) |
| [wallet-common](https://github.com/sirosfoundation/wallet-common) | 210 | MIT (174), Apache-2.0 (18), BSD-3-Clause (7), ISC (2), 0BSD (2), BSD-2-Clause (2), 0BSD AND ISC AND MIT (1), BSD-3-Clause AND ISC AND MIT (1), LicenseRef-scancode-generic-cla AND MIT (1), MIT AND Zlib (1), BSD-2-Clause AND CC0-1.0 AND ISC AND MIT (1) |
| [wallet-companion](https://github.com/sirosfoundation/wallet-companion) | 681 | MIT (499), Apache-2.0 (47), ISC (35), BSD-2-Clause (30), MPL-2.0 (18), BSD-3-Clause (14), LGPL-3.0-or-later (10), CC0-1.0 AND MIT (5), Apache-2.0 AND LGPL-3.0-or-later (3), BlueOak-1.0.0 (3), CC0-1.0 (2), Apache-2.0 AND MIT (2), MIT-0 (2), NOASSERTION (1), LicenseRef-scancode-unicode AND MIT (1), Apache-2.0 AND OFL-1.1 AND Ubuntu-font-1.0 (1), Python-2.0 (1), BSD-2-Clause AND BSD-2-Clause-Views (1), MIT AND Zlib (1), ISC AND MIT (1), BSD-2-Clause AND BSD-3-Clause (1), Apache-2.0 AND LGPL-3.0-or-later AND MIT (1), 0BSD (1), LGPL-3.0 (1) |
| [wallet-frontend](https://github.com/sirosfoundation/wallet-frontend) | 1105 | MIT (907), Apache-2.0 (60), ISC (40), BSD-2-Clause (21), BSD-3-Clause (19), MPL-2.0 (13), BSD-2-Clause AND LGPL-2.0-only AND LGPL-2.1-only AND LGPL-3.0-only AND LGPL-3.0-or-later AND LicenseRef-scancode-other-permissive AND MIT AND MPL-2.0 (10), CC0-1.0 AND MIT (3), Apache-2.0 AND BSD-2-Clause AND LGPL-2.0-only AND LGPL-2.1-only AND LGPL-3.0-only AND LGPL-3.0-or-later AND LicenseRef-scancode-other-permissive AND MIT AND MPL-2.0 (3), ISC AND MIT (3), Apache-2.0 AND BSD-2-Clause (2), BlueOak-1.0.0 (2), MIT-0 (2), CC0-1.0 (2), 0BSD (2), LicenseRef-scancode-public-domain (1), BSD-2-Clause AND BSD-2-Clause-Views (1), BSD-2-Clause AND BSD-3-Clause (1), Apache-2.0 AND OFL-1.1 AND Ubuntu-font-1.0 (1), CC-BY-4.0 (1), Apache-2.0 AND BSD-2-Clause AND BlueOak-1.0.0 AND CC0-1.0 AND ISC AND MIT (1), 0BSD AND ISC AND MIT (1), LicenseRef-scancode-generic-cla AND MIT (1), Python-2.0 (1), Apache-2.0 AND BSD-3-Clause AND ISC AND MIT (1), Apache-2.0 AND BSD-2-Clause AND CC0-1.0 AND ISC AND MIT (1), AFL-2.1 AND AFL-3.0 AND BSD-3-Clause (1), Apache-2.0 AND MIT (1), MIT AND Zlib (1), NOASSERTION (1), BSD-3-Clause AND MIT (1) |
...
| lightningcss | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-android-arm64 | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-darwin-arm64 | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-darwin-x64 | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-freebsd-x64 | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-linux-arm-gnueabihf | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-linux-arm64-gnu | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-linux-arm64-musl | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-linux-x64-gnu | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-linux-x64-musl | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-win32-arm64-msvc | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| lightningcss-win32-x64-msvc | 1.32.0 | MPL-2.0 | sbom | [go-invite-op](https://github.com/sirosfoundation/go-invite-op/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | LightningCSS — build-time CSS compiler |
...
| actions/checkout | 6.*.* | MIT | policy-override | [facetec-api](https://github.com/sirosfoundation/facetec-api/network/dependencies), [g119612](https://github.com/sirosfoundation/g119612/network/dependencies), [go-cryptoutil](https://github.com/sirosfoundation/go-cryptoutil/network/dependencies), [go-r2ps-service](https://github.com/sirosfoundation/go-r2ps-service/network/dependencies), [go-spocp](https://github.com/sirosfoundation/go-spocp/network/dependencies), [go-trust](https://github.com/sirosfoundation/go-trust/network/dependencies), [goFF](https://github.com/sirosfoundation/goFF/network/dependencies), [siros-sdk-kotlin](https://github.com/sirosfoundation/siros-sdk-kotlin/network/dependencies), [siros-sdk-swift](https://github.com/sirosfoundation/siros-sdk-swift/network/dependencies), [siros-verifier-app](https://github.com/sirosfoundation/siros-verifier-app/network/dependencies), [vc](https://github.com/sirosfoundation/vc/network/dependencies) | GitHub Actions — not in deliverable artifacts |
...
| actions/dependency-review-action | 5.*.* | MIT | policy-override | [facetec-api](https://github.com/sirosfoundation/facetec-api/network/dependencies), [g119612](https://github.com/sirosfoundation/g119612/network/dependencies), [go-r2ps-service](https://github.com/sirosfoundation/go-r2ps-service/network/dependencies), [go-trust](https://github.com/sirosfoundation/go-trust/network/dependencies), [go-wallet-backend](https://github.com/sirosfoundation/go-wallet-backend/network/dependencies), [siros-sdk-kotlin](https://github.com/sirosfoundation/siros-sdk-kotlin/network/dependencies), [siros-sdk-swift](https://github.com/sirosfoundation/siros-sdk-swift/network/dependencies), [siros-verifier-app](https://github.com/sirosfoundation/siros-verifier-app/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | GitHub Actions — not in deliverable artifacts |
...
| actions/setup-node | 6.*.* | MIT | policy-override | [vc](https://github.com/sirosfoundation/vc/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | GitHub Actions — not in deliverable artifacts |
...
| codecov/codecov-action | 7.*.* | MIT | policy-override | [facetec-api](https://github.com/sirosfoundation/facetec-api/network/dependencies), [go-r2ps-service](https://github.com/sirosfoundation/go-r2ps-service/network/dependencies), [go-wallet-backend](https://github.com/sirosfoundation/go-wallet-backend/network/dependencies), [siros-sdk-swift](https://github.com/sirosfoundation/siros-sdk-swift/network/dependencies) | Codecov actions — CI-only |
...
| codecov/codecov-action | 6.*.* | MIT | policy-override | [go-spocp](https://github.com/sirosfoundation/go-spocp/network/dependencies), [go-trust](https://github.com/sirosfoundation/go-trust/network/dependencies), [goFF](https://github.com/sirosfoundation/goFF/network/dependencies) | Codecov actions — CI-only |
...
| github/codeql-action/analyze | 4.*.* | MIT | policy-override | [facetec-api](https://github.com/sirosfoundation/facetec-api/network/dependencies), [g119612](https://github.com/sirosfoundation/g119612/network/dependencies), [go-cryptoutil](https://github.com/sirosfoundation/go-cryptoutil/network/dependencies), [go-r2ps-service](https://github.com/sirosfoundation/go-r2ps-service/network/dependencies), [go-spocp](https://github.com/sirosfoundation/go-spocp/network/dependencies), [go-trust](https://github.com/sirosfoundation/go-trust/network/dependencies), [go-wallet-backend](https://github.com/sirosfoundation/go-wallet-backend/network/dependencies), [goFF](https://github.com/sirosfoundation/goFF/network/dependencies), [siros-sdk-swift](https://github.com/sirosfoundation/siros-sdk-swift/network/dependencies), [siros-verifier-app](https://github.com/sirosfoundation/siros-verifier-app/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | GitHub official actions — CI-only |
...
| github/codeql-action/analyze | 3.*.* | MIT | policy-override | [wallet-common](https://github.com/sirosfoundation/wallet-common/network/dependencies), [wallet-frontend](https://github.com/sirosfoundation/wallet-frontend/network/dependencies) | GitHub official actions — CI-only |
| github/codeql-action/autobuild | 4.*.* | MIT | policy-override | [facetec-api](https://github.com/sirosfoundation/facetec-api/network/dependencies), [g119612](https://github.com/sirosfoundation/g119612/network/dependencies), [go-cryptoutil](https://github.com/sirosfoundation/go-cryptoutil/network/dependencies), [go-r2ps-service](https://github.com/sirosfoundation/go-r2ps-service/network/dependencies), [go-spocp](https://github.com/sirosfoundation/go-spocp/network/dependencies), [go-trust](https://github.com/sirosfoundation/go-trust/network/dependencies), [go-wallet-backend](https://github.com/sirosfoundation/go-wallet-backend/network/dependencies), [goFF](https://github.com/sirosfoundation/goFF/network/dependencies), [siros-sdk-swift](https://github.com/sirosfoundation/siros-sdk-swift/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | GitHub official actions — CI-only |
...
| github/codeql-action/init | 4.*.* | MIT | policy-override | [facetec-api](https://github.com/sirosfoundation/facetec-api/network/dependencies), [g119612](https://github.com/sirosfoundation/g119612/network/dependencies), [go-cryptoutil](https://github.com/sirosfoundation/go-cryptoutil/network/dependencies), [go-r2ps-service](https://github.com/sirosfoundation/go-r2ps-service/network/dependencies), [go-spocp](https://github.com/sirosfoundation/go-spocp/network/dependencies), [go-trust](https://github.com/sirosfoundation/go-trust/network/dependencies), [go-wallet-backend](https://github.com/sirosfoundation/go-wallet-backend/network/dependencies), [goFF](https://github.com/sirosfoundation/goFF/network/dependencies), [siros-sdk-swift](https://github.com/sirosfoundation/siros-sdk-swift/network/dependencies), [siros-verifier-app](https://github.com/sirosfoundation/siros-verifier-app/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | GitHub official actions — CI-only |
...
| github/codeql-action/init | 3.*.* | MIT | policy-override | [wallet-common](https://github.com/sirosfoundation/wallet-common/network/dependencies), [wallet-frontend](https://github.com/sirosfoundation/wallet-frontend/network/dependencies) | GitHub official actions — CI-only |
...
| pnpm/action-setup | 6.*.* | MIT | policy-override | [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies) | pnpm actions — CI-only |
...
| sirosfoundation/.github/.github/workflows/sbom.yml | 03160e376dbdeb9f2c904e7a9f45499b2f67e8fa | BSD-2-Clause | policy-override | [facetec-api](https://github.com/sirosfoundation/facetec-api/network/dependencies), [g119612](https://github.com/sirosfoundation/g119612/network/dependencies), [go-cryptoutil](https://github.com/sirosfoundation/go-cryptoutil/network/dependencies), [go-r2ps-service](https://github.com/sirosfoundation/go-r2ps-service/network/dependencies), [go-spocp](https://github.com/sirosfoundation/go-spocp/network/dependencies), [go-trust](https://github.com/sirosfoundation/go-trust/network/dependencies), [go-wallet-backend](https://github.com/sirosfoundation/go-wallet-backend/network/dependencies), [goFF](https://github.com/sirosfoundation/goFF/network/dependencies), [siros-sdk-kotlin](https://github.com/sirosfoundation/siros-sdk-kotlin/network/dependencies), [siros-sdk-swift](https://github.com/sirosfoundation/siros-sdk-swift/network/dependencies), [wallet-common](https://github.com/sirosfoundation/wallet-common/network/dependencies), [wallet-companion](https://github.com/sirosfoundation/wallet-companion/network/dependencies), [wallet-frontend](https://github.com/sirosfoundation/wallet-frontend/network/dependencies) | SIROS Foundation reusable workflows/actions |
...
_Last updated: 2026-06-30T07:47:05Z_
